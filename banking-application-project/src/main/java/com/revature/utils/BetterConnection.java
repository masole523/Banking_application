...
public class BetterConnection {
	...
	static {
		try {
			//save properties (key/value pair) into an object to work with
			InputStream input = ClassLoader.getSystemResourceAsStream("application.properties");
			Properties properties = new Properties();
			properties.load(input);
			
			// get the system variable name form the properties file
			...
			// get the value from the system variables
